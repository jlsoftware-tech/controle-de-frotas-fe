      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-2 border-border shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Atualize seus dados básicos. No momento este formulário é apenas para demonstração.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-5">
            <div className="space-y-1">
              <Input name="name" label="Nome Completo" defaultValue={user.name} disabled />
            </div>
            <div className="space-y-1">
              <Input name="email" label="Endereço de E-mail" defaultValue={user.email} disabled />
            </div>
            <div className="space-y-1">
              <Input name="role" label="Nível de Acesso" defaultValue={user.role} disabled />
            </div>
          </CardContent>
